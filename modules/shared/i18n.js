...
const STRINGS = {
  ...
  "analysis.workStyles": { ja: "HEXACO と職業の つながり", en: "HEXACO and work styles", "zh-Hans": "HEXACO 与职业风格" },
...
const exactTranslations = {
  ...
  "HEXACO（ヘキサコ・6因子）": { en: "HEXACO (six factors)", "zh-Hans": "HEXACO（六个维度）" },
  "HEXACO（デモ表示）": { en: "HEXACO (demo)", "zh-Hans": "HEXACO（演示）" },
  "HEXACO（活動から集計）": { en: "HEXACO (from activity)", "zh-Hans": "HEXACO（根据活动统计）" },
  ...
  "正直・謙虚": { en: "Honesty–Humility", "zh-Hans": "诚实・谦逊" },
  ...
  "English（テスト中）": { en: "English (testing)", "zh-Hans": "英语（测试中）" },
  "中文（测试中）": { en: "Chinese (testing)", "zh-Hans": "中文（测试中）" },
  ...
  "※ HEXACO と職業候補はプロトタイプの参考表示です。診断・評価ではありません。": { en: "※ HEXACO and work suggestions are reference displays in this prototype, not a diagnosis or evaluation.", "zh-Hans": "※ HEXACO 和职业建议仅为原型参考显示，不是诊断或评价。" },
